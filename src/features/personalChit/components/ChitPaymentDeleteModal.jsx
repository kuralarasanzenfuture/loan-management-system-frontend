...
import { AlertTriangle, Loader2, X, Receipt } from "lucide-react";
import { formatCurrency, formatDate } from "../utils/chitHelpers.js";

export default function ChitPaymentDeleteModal({
  open,
  payment,
  loading,
  error,
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-sm rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center gap-3 pt-2">
          ...
          <h3 className="font-bold text-base">Delete this installment?</h3>
        </div>
        ...
        <p className="text-sm text-base-content/60 text-center mt-4">
          This will permanently remove this payment record. This action cannot
          be undone.
        </p>
