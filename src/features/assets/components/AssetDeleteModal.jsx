...
import { AlertTriangle, Loader2, X, Package, ImageOff } from "lucide-react";
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-sm rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center gap-3 pt-2">
          ...
          <h3 className="font-bold text-base">Delete this asset?</h3>
        </div>

        <div className="flex items-center gap-3 mt-4 p-3 rounded-xl border border-base-300 bg-base-200/40">
          <div className="w-11 h-11 rounded-lg border border-base-300 bg-base-100 flex items-center justify-center overflow-hidden shrink-0">
            {asset.image ? (
              <img
                src={asset.image}
          ...
          <div className="min-w-0 text-left">
            <p className="font-semibold text-sm truncate">{asset.asset_name}</p>
        ...
        <p className="text-sm text-base-content/60 text-center mt-4">
          This will permanently remove this asset record. This action cannot be
          undone.
        </p>
