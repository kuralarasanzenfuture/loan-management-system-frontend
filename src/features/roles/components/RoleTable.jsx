...
/**
 * RoleTable
 * Presentational table — receives already-filtered roles and just renders
 * them, plus loading/empty states.
 *
 * Matches the API's role shape: { id, name, description, status }
 * (no permissions field, so that column has been removed.)
 *
 * Props:
 * - roles (array)
 * - loading (bool)
