 ...
 * Props:
 * - open (bool)
 * - plan (object|null) : { id, plan_name, plan_code }
 * - loading (bool)
 * - error (string|object|null)
 * - onConfirm (fn)
 * - onClose (fn)
 */
export default function LoanPlanDeleteModal({
  open,
  plan,
  loading,
  error,
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-sm rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center gap-3 pt-2">
          ...
          <h3 className="font-bold text-base">Delete this loan plan?</h3>
        </div>
        ...
        <p className="text-sm text-base-content/60 text-center mt-4">
          This will permanently remove the plan and its penalty configuration.
          Loans already issued under this plan will not be affected. This action
          cannot be undone.
        </p>
