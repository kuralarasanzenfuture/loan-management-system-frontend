...
export default function CustomerLoanDeleteModal({
  open,
  loan,
  loading,
  error,
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-sm rounded-2xl">
        ...
        <p className="text-sm text-base-content/60 text-center mt-4">
          This will permanently remove the loan record. Any linked repayment
          history may also be affected. This action cannot be undone.
        </p>
