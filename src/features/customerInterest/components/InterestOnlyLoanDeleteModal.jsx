...
import { AlertTriangle, Loader2, X, Percent } from "lucide-react";
import { formatCurrency } from "../utils/interestOnlyLoanHelpers.js";

export default function InterestOnlyLoanDeleteModal({
  open,
  loan,
  loading,
  error,
    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-sm rounded-2xl">
        ...
        <div className="flex flex-col items-center text-center gap-3 pt-2">
          ...
          <h3 className="font-bold text-base">Delete this loan?</h3>
        </div>
        ...
        <div className="flex items-center gap-3 mt-4 p-3 rounded-xl border border-base-300 bg-base-200/40">
          ...
          <div className="min-w-0 text-left">
            <p className="font-semibold text-sm truncate">{loan.loan_no}</p>
        ...
        <p className="text-sm text-base-content/60 text-center mt-4">
          This will permanently remove this loan record. Payments already
          recorded against it may prevent deletion if your backend enforces
          referential integrity. This action cannot be undone.
        </p>
